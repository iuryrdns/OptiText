...
If you find a security vulnerability in OptiText, please report it through [GitHub's private vulnerability reporting](https://github.com/iuryrdns/OptiText/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact iury32211@outlook.com for details.
