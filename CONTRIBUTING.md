...
Report bugs at https://github.com/iuryrdns/OptiText/issues.
...
OptiText could always use more documentation, whether as part of the official docs, in docstrings, or even on the web in blog posts, articles, and such.
...
The best way to send feedback is to file an issue at https://github.com/iuryrdns/OptiText/issues.
...
Ready to contribute? Here's how to set up OptiText for local development.

1. Fork the OptiText repo on GitHub.
2. Clone your fork locally:

   ```sh
   git clone git@github.com:your_name_here/OptiText.git
   ```
