...
OptiText started out as a project generated from [Cookiecutter PyPackage](https://github.com/audreyfeldroy/cookiecutter-pypackage) containing:

- Initial scaffold for OptiText.
- `src/optitext/` package with CLI (Typer + Rich), py.typed marker
...
[@iuryrdns](https://github.com/iuryrdns) (Iury Ruan do N. Santos) created OptiText.
